...
public class ClubDefaultController implements ClubController {
    ...
    @Autowired
    public ClubDefaultController(ClubService service, ClubsToResponseFunction clubsToResponse, ClubToResponseFunction clubToResponse, RequestToPlayerFunction requestToPlayerFunction, PlayerService playerService) {
    ...
    public void deleteClub(long id) {
        //service.findById(id).getPlayers().forEach(it -> playerService.delete(it.getUuid()));
        service.delete(id);
    }
}
